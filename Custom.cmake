...
if (WIN32)
	configure_file(rai/rai_node/rai_node.rc.in "rai/rai_node/CMakeFiles/rai_node.rc" NEWLINE_STYLE WIN32)
	set_source_files_properties(rai/rai_node/CMakeFiles/rai_node.rc LANGUAGE RC)
endif ()
...
if (APPLE)
	...
	set (MACOSX_BUNDLE_EXECUTABLE_NAME "rai_node")
	...
	configure_file(rai/rai_node/Info.plist.in "rai/rai_node/CMakeFiles/Info.plist")

	set (CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-sectcreate,__TEXT,__info_plist,${PROJECT_SOURCE_DIR}/rai/rai_node/CMakeFiles/Info.plist")
endif ()
